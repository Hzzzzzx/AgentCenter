...
This project is indexed by GitNexus as **AgentCenter** (8535 symbols, 20074 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
