...
| `agentcenter-bridge/` | Java Spring Boot Bridge，管理事项、工作流、会话、确认项、Runtime Adapter | `mvn test` / `mvn clean package` |
...
This project is indexed by GitNexus as **AgentCenter** (8597 symbols, 20182 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
