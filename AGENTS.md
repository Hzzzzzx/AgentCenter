...
This project is indexed by GitNexus as **AgentCenter** (9199 symbols, 22084 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
