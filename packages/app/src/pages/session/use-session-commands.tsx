...
export const useSessionCommands = (actions: SessionCommandContext) => {
  ...
  const shareCmds = () => {
    if (!AgentCenterFeatures.sessionSharing) return []
  ...
  const sessionCmds = () => [
    ...
    ...(AgentCenterFeatures.sessionFork
      ? [
          sessionCommand({
            id: "session.fork",
  ...
  const viewCmds = () => [
    ...(AgentCenterFeatures.terminalPanel
      ? [
          viewCommand({
            id: "terminal.toggle",
  ...
  const modelCmds = () => [
    ...
    ...(AgentCenterFeatures.modelVariantSwitcher
      ? [
          modelCommand({
  ...
  const mcpCmds = () => [
    ...(AgentCenterFeatures.mcpSelector
      ? [
          mcpCommand({
            id: "mcp.toggle",
  ...
  const agentCmds = () => [
    ...(AgentCenterFeatures.agentSwitcher
      ? [
          agentCommand({
            id: "agent.cycle",
