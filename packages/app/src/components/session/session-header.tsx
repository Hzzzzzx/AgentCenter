...
import { AgentCenterFeatures } from "@/agentcenter/features"
...
export function SessionHeader() {
  ...
  const term = createMemo(
    () => AgentCenterFeatures.terminalPanel && (!isDesktopBeta || settings.general.showTerminal()),
  )
  const status = createMemo(
    () => AgentCenterFeatures.statusPopover && (!isDesktopBeta || settings.general.showStatus()),
  )
        ...
        {(mount) => (
          <Portal mount={mount()}>
            <div class="flex items-center gap-2">
              <Show when={AgentCenterFeatures.rawWorkspaceActions && projectDirectory()}>
