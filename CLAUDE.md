...
This project is indexed by GitNexus as **AgentCenter** (10906 symbols, 27108 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
