...
This project is indexed by GitNexus as **AgentCenter** (6419 symbols, 15334 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
